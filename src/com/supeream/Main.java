...
//                System.exit(0);
    ...
    public static void main(String[] args) {
        ...
        options.addOption("C2555", false, "Select CVE-2020-2555");
        ...
        try {
            ...
            if (cmdLine.hasOption("U")) {
                ...
                WebLogicOperation.unInstallRmi(host, port,Main.cmdLine.hasOption("C2555"));
            ...
            //if choice of CVE-2555, not check that.
            if(!Main.cmdLine.hasOption("C2555")){
            ...
            WebLogicOperation.installRmi(host, port,Main.cmdLine.hasOption("C2555"));
